...
# Data
      # Species list
speciesList <- read.xlsx('2. Formatted Datasets - Tabular/Ref_Species.xlsx', sheet=2) %>%
...
criteria_definitions <- read.xlsx("1. Source Datasets/Wildlife Conservation Society Canada/KBACriteria_Definitions.xlsx")
...
#step <- 1
  ...
  if(includeQuestions){
    if(includeReviewDetails){
      if(scope == "Global and National"){
        template <- '1. Source Datasets/Wildlife Conservation Society Canada/KBA Summaries - Templates/KBASummary_Template_NewForm_Questions_Review_GlobalNational.docx'
        ...
        template <- '1. Source Datasets/Wildlife Conservation Society Canada/KBA Summaries - Templates/KBASummary_Template_NewForm_Questions_Review_Global.docx'
        ...
        template <- '1. Source Datasets/Wildlife Conservation Society Canada/KBA Summaries - Templates/KBASummary_Template_NewForm_Questions_Review_National.docx'
      ...
      if(scope == "Global and National"){
        template <- '1. Source Datasets/Wildlife Conservation Society Canada/KBA Summaries - Templates/KBASummary_Template_NewForm_Questions_NoReview_GlobalNational.docx'
        ...
        template <- '1. Source Datasets/Wildlife Conservation Society Canada/KBA Summaries - Templates/KBASummary_Template_NewForm_Questions_NoReview_Global.docx'
        ...
        template <- '1. Source Datasets/Wildlife Conservation Society Canada/KBA Summaries - Templates/KBASummary_Template_NewForm_Questions_NoReview_National.docx'
    ...
    if(includeReviewDetails){
      if(scope == "Global and National"){
        template <- '1. Source Datasets/Wildlife Conservation Society Canada/KBA Summaries - Templates/KBASummary_Template_NewForm_NoQuestions_Review_GlobalNational.docx'
        ...
        template <- '1. Source Datasets/Wildlife Conservation Society Canada/KBA Summaries - Templates/KBASummary_Template_NewForm_NoQuestions_Review_Global.docx'
        ...
        template <- '1. Source Datasets/Wildlife Conservation Society Canada/KBA Summaries - Templates/KBASummary_Template_NewForm_NoQuestions_Review_National.docx'
      ...
      if(scope == "Global and National"){
        template <- '1. Source Datasets/Wildlife Conservation Society Canada/KBA Summaries - Templates/KBASummary_Template_NewForm_NoQuestions_NoReview_GlobalNational.docx'
        ...
        template <- '1. Source Datasets/Wildlife Conservation Society Canada/KBA Summaries - Templates/KBASummary_Template_NewForm_NoQuestions_NoReview_Global.docx'
        ...
        template <- '1. Source Datasets/Wildlife Conservation Society Canada/KBA Summaries - Templates/KBASummary_Template_NewForm_NoQuestions_NoReview_National.docx'
...
KBAforms = "G:/My Drive/KBA Canada Team/KBAProposal_Ojibway Prairie Complex and Greater Park Ecosystem- 08.27.2021-RR.xlsm"
